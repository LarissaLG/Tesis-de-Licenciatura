...
\degreedate{2025}% Year of the dissertation
...
\input{1-Esparcimiento/1-Fundamentos}
	\input{1-Esparcimiento/2-Secciones_Transversales}
	\input{1-Esparcimiento/3-Kramers_Kronig}	
\input{2-Eritrocitos/1-Eritrocitos}
\input{3-FEM/1-Convergencia}
...
\appendix
\input{7-Apéndices/1-Something_extra.tex}  
