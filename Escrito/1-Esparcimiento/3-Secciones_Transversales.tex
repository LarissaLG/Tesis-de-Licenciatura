...
\end{equation}
%%
donde el integrando corresponde a la sección transversal diferencial de esparcimiento, una magnitud que puede medirse experimentalmente y que se denota por $\dd{C_{\text{sca}}}/\dd{\Omega}$ \cite{bohrenAbsorptionScatteringLight2008}.
% --- JAUA ---
