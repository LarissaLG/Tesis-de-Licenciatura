...
% --- JAUA ---
% ángulo sólido no es una varable: esta siguen siendo separas y sn theta y phi. Más bien solo mencionar que asi se le conoce a la integración y no creo que sea neceariauna referencia además del bohren o cualquier libro de óptica. Además, así no se citan los portales de internet (ni URL pusiste.) Adempas en tu mismo texto dices que Omega esuna variable y el nombre de la sperficoe: es confiso.
% Escribir explicitamente d\omega = \sin\ŧheta\dtheta\d\phi 
%
