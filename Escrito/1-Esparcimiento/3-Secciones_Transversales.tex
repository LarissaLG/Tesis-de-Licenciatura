...
Al reescribir el vector de amplitud de esparcimiento [Ec. (\ref{eq:Xvec})] en términos de la base vectorial esférica se obtiene \cite{bohrenAbsorptionScatteringLight2008}
%
\begin{equation}
