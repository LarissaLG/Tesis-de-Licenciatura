...
\begin{figure}[t]
	\centering
	\includegraphics[width=8.3cm]{../../Figuras/1-Esparcimiento/scattering.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=6.6cm]{../../Figuras/1-Esparcimiento/WA.pdf}
...
donde 
% --- JAUA ---
% Así como está no tiene sentido la escritura. Te propongo que pongas que el integrando de esa ecuación también se conoce como XXXX, y que es de utilidad por ser una cantidad que se puede medir experimentalmente y se denota como [y aquú pones referencias]. Y ya
%
\begin{equation}
	\frac{\dd{C_{\text{sca}}}}{\dd{\Omega}}=\frac{|\vb{X}|^2}{k^2},
\end{equation}
%%
es la sección transversal de esparcimiento diferencial, que indica la distribución angular de la onda esparcida \cite{bohrenAbsorptionScatteringLight2008}. Finalmente, la Ec. (\ref{Wext_tot}) puede ser reescrita como \cite{bohrenAbsorptionScatteringLight2008}
%
\begin{tcolorbox}[ams align]
