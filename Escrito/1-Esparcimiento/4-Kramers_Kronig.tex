...
\begin{figure}[h!]
	\centering
	\includegraphics[width=8cm]{../../Figuras/1-Esparcimiento/integration.pdf}
...
\end{equation}
%
donde PV denota el valor principal de la integral \cite{arfkenMathematicalMethodsPhysicists2011}. Por lo tanto, se obtiene 
%
\begin{equation}
