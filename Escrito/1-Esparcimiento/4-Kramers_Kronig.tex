...
\end{align}
A partir de que la propiedad de simetría $\varepsilon(-\omega)/\varepsilon_0=\varepsilon^*(\omega^*)/\varepsilon_0$, las Ecs. \eqref{seq:ReKK_inf} y \eqref{seq:ImKK_inf} se reescriben en frecuencias positivas como
\begin{subequations}%
	\begin{tcolorbox}[
		ams align, breakable]
