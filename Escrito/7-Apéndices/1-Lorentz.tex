...
\begin{figure}[t]
	...
	\sidesubfloat[Second image]{\hspace{-0.6cm}{		\includegraphics[width=0.46\textwidth]{../../Figuras/2-Eritrocitos/ajusteLorentz30.pdf}\label{subfig:ajusteLorentz28}}}\\
	\vspace{0.5cm}
	\sidesubfloat[Second image]{\hspace{-0.6cm}{		\includegraphics[width=0.47\textwidth]{../../Figuras/2-Eritrocitos/ajusteLorentz34.pdf}\label{subfig:ajusteLorentz30}}}\hspace{0.1cm}
	\sidesubfloat[Second image]{\hspace{-0.8cm}{		\includegraphics[width=0.52\textwidth]{../../Figuras/2-Eritrocitos/ajustePlasma.pdf}\label{subfig:ajusteLorentzPlasma}}}
