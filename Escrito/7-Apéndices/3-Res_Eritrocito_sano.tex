...
\begin{figure}[h!]
	\centering
			...
			\includegraphics[width=14cm]{../../Figuras/4-Resultados/linearplot541FF_EriSano.pdf}\label{subfig:FF_cartesian_541_health}\vspace{-0.1cm}
...
\begin{figure}[tb]
	\centering
			...
			\includegraphics[width=14cm]{../../Figuras/4-Resultados/linearplot573FF_EriSano.pdf}\label{subfig:FF_cartesian_573_health}\vspace{-0.1cm}
	\caption{Sección transversal diferencial de esparcimiento $\dd{C_{\text{sca}}}/\dd{\Omega}$ en función de $\theta$ para dos cortes: $\varphi=0^{\circ}$ (puntos azules claro) y $\varphi=90^{\circ}$ (puntos azules oscuro). La línea continua que une los puntos es una guía visual.}
	\label{fig:FF_573_health_2}
\end{figure}
%