...
\begin{figure}[h]
	...
	\includegraphics[width=0.45\textwidth]{../../Figuras/2-Eritrocitos/ajusteLorentzLegend.pdf}\\
	\sidesubfloat[First image]{\hspace{-0.8cm}{
			\includegraphics[width=0.47\textwidth]{../../Figuras/2-Eritrocitos/sskk15_0.pdf}\label{subfig:SSKK15}}}\hspace{0.1cm}
	\sidesubfloat[Second image]{\hspace{-0.6cm}{		\includegraphics[width=0.47\textwidth]{../../Figuras/2-Eritrocitos/sskk28_0.pdf}\label{subfig:SSKK28}}}	\vspace{-0.2cm}
...
\begin{figure}[]
	...
	\sidesubfloat[Second image]{\hspace{-0.8cm}{		\includegraphics[width=0.47\textwidth]{../../Figuras/2-Eritrocitos/sskk30_0.pdf}\label{subfig:SSKK30}}}\hspace{0.1cm}
	\sidesubfloat[Second image]{\hspace{-0.6cm}{		\includegraphics[width=0.47\textwidth]{../../Figuras/2-Eritrocitos/sskkPlasma_0.pdf}\label{subfig:SSKKPlasma}}} \vspace{-0.2cm}
